...
const Sidebar = () => {
  ...
  return (
    <div className='sticky top-0 hidden md:flex flex-col items-center justify-center p-8 w-[20%] gap-4 outline outline-outline outline-1 border-r-outline h-[100vh]'>
